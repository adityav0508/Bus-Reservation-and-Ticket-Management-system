...
public class BusReservationAndTicketingSystem {
    ...
    for(int i=1;i<4;){
    	...
    	if(user.equals("travel") && password.equals("wantstogo")){
    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)kanna chowk   |   "+available[1]+"   **");
    					System.out.println("** 2.)railway station       |   "+available[2]+"   **");
    					System.out.println("** 3.)akkalkoat             |   "+available[3]+"   **");
    					System.out.println("** 4.)pandharpur            |   "+available[4]+"   **");
    					System.out.println("** 5.)nashik                |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "kanna chowk", "railway station", "CABADBARAN", "TANDAG", "CAGAYAN"};
